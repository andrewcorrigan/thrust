...
template<class CharType, class CharTrait>
void
print_helper(CharType, std::basic_ostream<CharType, CharTrait>&)
{
}

template<class CharType, class CharTrait, class T>
void
print_helper(CharType, std::basic_ostream<CharType, CharTrait>& o, const T& t)
{
  o << t;
}
...
template<class CharType, class CharTrait, class... Types, size_t... Is>
inline std::basic_ostream<CharType, CharTrait>&
print(std::basic_ostream<CharType, CharTrait>& o, const thrust::tuple<Types...>& t, thrust::index_sequence<Is...>)
{
  const CharType d = detail::tuple_detail::format_info::get_manipulator(o, detail::tuple_detail::format_info::delimiter);

  print_helper(d, o, thrust::get<Is>(t)...);
...
operator<<(std::basic_ostream<CharType, CharTrait>& o, 
  ...
  detail::tuple_detail::print(o, t, thrust::make_index_sequence<thrust::tuple_size<thrust::tuple<Types...>>::value>{});   // XXX thrust::index_sequence_for<Types...>{} upon variadic tuple
...
template<class CharType, class CharTrait>
void
read_helper(std::basic_istream<CharType, CharTrait> &)
{
}
...
template<class CharType, class CharTrait, class... Types, size_t... Is>
inline std::basic_istream<CharType, CharTrait>& 
read(std::basic_istream<CharType, CharTrait> &is, thrust::tuple<Types...>& t, thrust::index_sequence<Is...>)
{
  if (!is.good()) return is;
  read_helper(is, thrust::get<Is>(t)...);
  return is;
}
...
operator>>(std::basic_istream<CharType, CharTrait>& is, thrust::tuple<Types...>& t) {
  ...
  detail::tuple_detail::read(is, t, thrust::make_index_sequence<thrust::tuple_size<thrust::tuple<Types...>>::value>{});   // XXX thrust::index_sequence_for<Types...>{} upon variadic tuple
